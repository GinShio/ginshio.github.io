...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/3/37/Bubble_sort_animation.gif" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/2/25/Insertion_sort_animation.gif" >}}
...
以步长 \\([1, 3, 5]\\) 、序列 \\([13, 14, 94, 33, 82, 25, 59, 94, 65, 23, 45, 27, 73,
25, 39, 10]\\) 为例，下图是 Shell sort 的排序过程：

{{< figure src="/ox-hugo/shell-sort-example.svg" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/1/1b/Sorting_heapsort_anim.gif" >}}
...
{{< figure src="/ox-hugo/merge-sort-example.svg" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/c/c5/Merge_sort_animation2.gif" >}}
...
{{< figure src="https://upload.wikimedia.org/wikipedia/commons/6/6a/Sorting_quicksort_anim.gif" >}}
...
permutation) 算法，直接介绍的对链表的排序就是这种算法。

{{< figure src="/ox-hugo/in-situ-permutation-example.svg" >}}
