...
{{< figure src="/ox-hugo/file-structure.svg" >}}
...
{{< figure src="/ox-hugo/unix-directory-tree.svg" >}}
...
{{< figure src="/ox-hugo/file-system-layout-example.svg" >}}
...
1.  **连续分配**
    ...
    {{< figure src="/ox-hugo/disk-sequential-allocation-example.svg" >}}
...
2.  **链表分配**
    ...
    {{< figure src="/ox-hugo/disk-list-allocation-example.svg" >}}
...
{{< figure src="/ox-hugo/vfs-example.svg" >}}
...
{{< figure src="/ox-hugo/file-system-block-check-status.svg" >}}
