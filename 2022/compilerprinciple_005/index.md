...
{{< figure src="/ox-hugo/id-plus-id-multi-id-example-lm-top-down.svg" >}}
...
{{< figure src="/ox-hugo/top-down-parsing-process-example.svg" caption="<span class=\"figure-number\">Figure 1: </span>自顶向下语法分析器过程" >}}
...
{{< figure src="/ox-hugo/top-down-parsing-process-example-follow-and-first.svg" caption="<span class=\"figure-number\">Figure 2: </span>终结符 c 在 `FIRST`(_A_) 中且 a 在 `FOLLOW`(_A_) 中" >}}
...
{{< figure src="/ox-hugo/predictive-analyzer-transformation-graph-for-e-and-e-skim.svg" >}}
...
{{< figure src="/ox-hugo/analysis-table-driven-predictive-analyzer-model.svg" >}}
