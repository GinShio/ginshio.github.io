...
{{< figure src="/ox-hugo/alpha-beta-w-parsing-tree-handle.svg" >}}
...
{{< figure src="/ox-hugo/LR-0-automachine-example.svg" >}}
...
{{< figure src="/ox-hugo/LR-parser-model.svg" >}}
...
{{< figure src="/ox-hugo/analysis-table-of-SLR-example.svg" >}}
...
{{< figure src="/ox-hugo/LR-1-automachine-example.svg" >}}
...
{{< figure src="/ox-hugo/analysis-table-of-LR-1-example.svg" >}}
...
{{< figure src="/ox-hugo/LALR-1-automachine-example.svg" >}}

其分析表也很简单。

{{< figure src="/ox-hugo/analysis-table-of-LALR-1-example.svg" >}}
...
{{< figure src="/ox-hugo/analysis-table-of-ambiguous-grammar.svg" >}}
...
{{< figure src="/ox-hugo/analysis-table-of-ambiguous-grammar-for-if-else.svg" >}}
