...
需要注意的是，并非网络编程需要用到 I/O 复用，其他场景下也有其适用的空间。
...
-   **blocking I/O** (阻塞式 I/O)
    ...
    {{< figure src="/ox-hugo/blocking-io-model.svg" >}}
...
-   **nonblocking I/O** (非阻塞式 I/O)
    ...
    {{< figure src="/ox-hugo/nonblocking-io-model.svg" >}}
...
-   **I/O multiplexing** (I/O 复用, e.g. select, poll)
    ...
    {{< figure src="/ox-hugo/io-multiplexing-model.svg" >}}
...
-   **signal driven I/O** (信号驱动型 I/O, e.g. SIGIO)
    ...
    {{< figure src="/ox-hugo/signal-driven-io-model.svg" >}}
...
-   **asynchronous I/O** (异步 I/O, e.g. POSIX aio_xxx functions)
    ...
    {{< figure src="/ox-hugo/asynchronous-io-model.svg" >}}
...
{{< figure src="/ox-hugo/comparison-of-the-five-io-models.svg" >}}
...
{{< figure src="/ox-hugo/conditions-handled-by-select-in-strcli.svg" >}}
...
{{< figure src="/ox-hugo/time-line-of-stop-and-wait-mode-interactive-input.svg" >}}
...
{{< figure src="/ox-hugo/filling-the-pipe-between-the-client-and-server-batch-mode.svg" >}}
...
```text
-rw-r--r-- 1 GinShio users 7106 Feb 27 18:58 in.txt
-rw-r--r-- 1 GinShio users 4139 Feb 27 18:58 out.txt
```
