...
* Compiler
 ...
 + [[https://discourse.llvm.org/][LLVM Community]]
 + [[https://godbolt.org/][Compiler Explorer]]

** 简介

 + [[https://aosabook.org/en/v1/llvm.html][AOSA V1 - LLVM]]
...
[[file:../images/llvmir-cfg-example-function_sum.svg]]
...
CFG:
 ...
 + [[https://llvm.org/devmtg/2017-10/slides/Kuderski-Dominator_Trees.pdf][Dominator Tree]]
 + [[https://llvm.org/docs/LoopTerminology.html][Loop]]: LCSSA

[[file:../images/llvmir-cfg-example-function_sum-dom.svg]]

** 优化

 + [[https://llvm.org/docs/UserGuides.html#optimizations][Optimizations]]
 + [[https://llvm.org/docs/Passes.html][LLVM’s Analysis and Transform Passes]]
