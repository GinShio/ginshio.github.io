...
\begin{tikzpicture}[
  ...
  \path[draw=Orange]
  (graphE) -- (graphD) -- (graphJ) -- (graphE);
  \path[draw=DodgerBlue]
  (graphD) -- (graphA) -- (graphC) -- (graphG) -- (graphD) -- (graphK) -- (graphJ) --
  (graphG) -- (graphI) -- (graphC) -- (graphD);
  \path[draw=MediumAquamarine]
  (graphC) -- (graphB) -- (graphH) -- (graphI) -- (graphF) -- (graphC);
  \path[draw=DarkMagenta]
  (graphI) -- (graphL) -- (graphJ) -- (graphI);
\end{tikzpicture}
\end{document}
